"""Tests the service due window class."""
import pytest
import tkinter as tk

from ..window_classes import VehiclesWithServiceDue

window_instance = VehiclesWithServiceDue(tk.Tk())
...
def test_widgets():
    ...
    expected_title_text = 'Vehicles with Services Due in the Next Month'
